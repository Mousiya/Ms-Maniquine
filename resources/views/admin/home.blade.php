        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Deliveries</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                        ...
                        <div class="card white-box p-0">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row p-3 mt-0">
                                    <div class="p-2"><img src="admin/plugins/images/users/varun.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="admin/plugins/images/users/genu.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="admin/plugins/images/users/ritesh.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text ps-2 ps-md-3 w-100">
                                ...
                                <ul class="chatonline">
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="admin/plugins/images/users/varun.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="admin/plugins/images/users/genu.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="admin/plugins/images/users/ritesh.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="admin/plugins/images/users/arijit.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="admin/plugins/images/users/govinda.jpg" alt="user-img"
                                                class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="admin/plugins/images/users/hritik.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
