              ...
              <div class="row mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="confirm('Are you sure, You want to delete this size?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSize({{$size->id}})" style="margin-left:10px;"><i class="fe fe-16 fe-delete"></i> </a>
                            </td>
                            </tr>
                            @endforeach
                            @else
                ...
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                    <form enctype="multipart/form-data" wire:submit.prevent="updatesize">
                      @csrf           
                      <div class="row">
                        <div class="col-md-12">
                  ...
                  <a class="btn btn-secondary" href="{{route('admin.sizes')}}"> 
                    Back</a>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col -->
