            ...
            <div class="col-12">
              ...
              <div class="row mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="confirm('Are you sure, You want to delete this colour?') || event.stopImmediatePropagation()" wire:click.prevent="deleteColor({{$color->id}})" style="margin-left:10px;"><i class="fe fe-16 fe-delete"></i> </a>
                            </td>
                            </tr>
                            @endforeach
                            @else
                ...
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong>Edit Colour</strong>
                    </div>
                    <div class="card-body">
                    <form enctype="multipart/form-data" wire:submit.prevent="updatecolor">
                      @csrf           
                      <div class="row">
                        <div class="col-md-12">
                  ...
                  <a class="btn btn-secondary" href="{{route('admin.colours')}}"> 
                    Back</a>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col -->
