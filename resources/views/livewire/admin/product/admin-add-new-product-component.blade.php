                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                              <div class="form-group col-sm-4">
                                <label for="example-fileinput">Dress Image</label>
                              ...
                              <div class="form-group col-sm-8">
                                <label for="example-fileinput">Dress Gallery</label>
                                <input type="file" id="example-fileinput" class="form-control-file" wire:model="images" multiple>
                                  @if($images)
                            ...
                            <div class="form-group row">
                              <div class="form-group col-sm-4">
                                <label for="example-fileinput">Size Chart</label>
                                <input type="file" id="example-fileinput" class="form-control-file" wire:model="sizechart">
                                  @if($sizechart)
                                      <img src="{{$sizechart->temporaryUrl()}}" width="120" height="40"/>
                                  @endif
                              </div>
                              <div class="form-group col-sm-8">
