                    ...
                    <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                        <div class="product product-style-3 equal-elem ">
                            <div class="product-thumnail">
                                ...
                                <figure><img class="dress-image" src="{{asset('assets/images/dresses')}}/{{$dress->image}}" width="600" height="700" alt="{{$dress->name}}"></figure>
                            </a>
                            </div>
                            <div class="product-info">
                                <a href="{{route('dress.details',['dress_id'=>$dress->id])}}"class="product-name"><span>{{$dress->name}}</span></a>
                                <div class="wrap-price"><span class="product-price">{{$dress->name}}</span></div>
