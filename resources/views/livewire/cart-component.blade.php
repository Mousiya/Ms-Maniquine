<main id="main" class="main-site">
		<div class="container">
			...
			<div class=" main-content-area">
				@if(Cart::instance('cart')->count()>0)
					<div class="wrap-item-in-cart">
						...
						<ul class="products-cart">
							...
							<li class="pr-cart-item">
								<div class="product-image">
									<figure><img src="{{asset('assets/images/dresses')}}/{{$item->model->image}}" alt="{{$item->model->name}}"></figure>
								</div>
								<div class="product-name">
									<a class="link-to-product" href="{{route('dress.details',['dress_id'=>$item->model->id])}}">{{$item->model->name}}</a>
								</div>
								@foreach($item->options as $av=>$name)
								...
								@if($item->model->sale_price>0 && $sale->status ==1 && $sale->sale_date > Carbon\Carbon::now())
									<div class="price-field product-price"><p class="price">{{$item->model->sale_price}}</p></div>
								@else
						...
						<div class="text-center" style="padding:30px 0;">
							<figure><img src="{{asset('assets\images\shoppage\emptycart.png')}}" alt="" width="250" height="250"></figure>
				...
				@else
					<div class="text-center" style="padding:30px 0;">
					<figure><img src="assets\images\shoppage\emptycart.png" alt="" width="250" height="250"></figure>
						<h1>Your cart is empty!</h1>
						<p>Add items to it now</p>
						<a href ="/shop" class="btn btn-success"> Shop Now </a>
					</div>
				...
				<div class="wrap-iten-in-cart">
					<h3 class="title-box" style ="border-botton:1px solid; padding-bottom:15px;" >{{Cart::instance('saveForLater')->count()}} item(s) Saved for later</h3>
