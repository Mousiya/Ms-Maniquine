								...
								<p class="row-in-form">
									...
									<div class="col-md-12">
										...
										<p class="row-in-form">
											...
											<input type="text" name="line2" value="" placeholder="Line2" wire:model="line2">
										</p>
										<p class="row-in-form">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									...
									<div class="col-md-12">
										...
										<p class="row-in-form">
											<label for="line2">Line2</label>
											<input type="text" name="line2" value="" placeholder="Line2" wire:model="s_line2">
										</p>
										<p class="row-in-form">
											<label for="city">City<span>*</span></label>
					...
					<div class="summary-item payment-method">
						...
						<div class="choose-payment-methods">
							<label class="payment-method">
								<input name="payment-method" id="payment-method-bank" value="cash on delivery" type="radio" wire:model="paymentmode">
