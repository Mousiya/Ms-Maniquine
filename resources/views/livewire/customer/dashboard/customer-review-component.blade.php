                    ...
                    <ol class="commentlist">
                        <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                            <div id="comment-20" class="comment_container"> 
                                <img alt="" src="{{ asset('assets/images/dresses')}}/{{$orderDetails->dress->image}}" height="80" width="80">
                                <div class="comment-text">
                                    <p class="meta"> 
                                        <strong class="woocommerce-review__author">{{$orderDetails->dress->name}}</strong> 
                                    </p>
                                </div>
                            </div>
                        </li>
                            ...
                            <form wire:submit.prevent="addReview" id="commentform" class="comment-form">
                                <div class="comment-form-rating">
                                    ...
                                    <p class="stars">
                                        ...
                                        @error('rating')<span class="text-danger"></span>@enderror
                                    </p>
                                </div>
                                <p class="comment-form-comment">
                                    ...
                                    @error('comment')<span class="text-danger"></span>@enderror
                                </p>
                                <p class="form-submit">
